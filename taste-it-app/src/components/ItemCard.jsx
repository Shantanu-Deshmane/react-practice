...
function ItemCard({id, img, name, price, rating, desc }) {
        ...
        <>
            <div  className=' p-4 bg-white rounded shadow-md lg:w-[250px] flex flex-col gap-2'>
                ...
                <div className='flex justify-between items-center'>
                    ...
                    <button onClick={() => dispatch(addItem({ name, img, id, price, qty : 1}))} className='bg-orange-500 txt-white text-sm py-1 px-3 rounded text-white'>Add to cart</button>
                </div>
            </div>
        </>
    )
