...
function ItemCard({key, id, img, name, price, rating, desc}) {
  return (
    <>
        <div className=' p-4 bg-white rounded shadow-md lg:w-[250px] flex flex-col gap-2'>
            ...
            <div className='flex justify-between items-center'>
                <span className='flex items-center justify-center gap-1 '><FaStar className='text-yellow-400'/>4.5</span>
                <button className='bg-orange-500 txt-white text-sm py-1 px-3 rounded text-white'>Add to cart</button>
            </div>
        </div>
    </>
  )
